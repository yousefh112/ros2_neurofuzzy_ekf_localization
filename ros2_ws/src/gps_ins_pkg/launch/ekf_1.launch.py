# Standalone EKF1 launch (ekf_local + ekf_filter_node_gps_imu + navsat_transform).
...
def generate_launch_description():
    robot_localization_dir = get_package_share_directory('gps_ins_pkg')
    parameters_file_dir = os.path.join(robot_localization_dir, 'config')
    parameters_file_path = os.path.join(parameters_file_dir, 'ekf_1.yaml')
